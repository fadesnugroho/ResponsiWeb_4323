...
<template>
  ...
  <nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-32 p-4">
      <div class="flex">
        <img src="../../Components/images/logo.png" class="h-8 mr-3" alt="Fades" />
        <h1 class="text-lg font-bold">Fades Nugroho</h1>
      </div>
      <button
        ...
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
          ...
          <li>
            <div v-if="canLogin">
              ...
              <template v-else>
                <Link :href="route('login')" type="button" class="text-black bg-yellow-500 hover:bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-3 py-2 text-center mr-3 md:mr-0"> Log in</Link>
              </template>
            </div>
          </li>
        </ul>
      ...
      <div class="flex flex-col-reverse lg:flex-row items-center lg:py-5 lg:order-first">
        <div class="lg:w-6/12 lg:ms-10 text-black">
          ...
          <div class="grid grid-cols-1 gap-2 md:flex md:justify-start">
            <button type="button" class="bg-yellow-500 hover:bg-yellow-400 text-black rounded-lg px-5 py-3 mt-7">Primary</button>
            <button type="button" class="bg-gray-300 hover:bg-gray-200 text-black rounded-lg px-5 py-3 mt-7">Default</button>
          </div>
        </div>
        <div class="lg:w-6/12">
      ...
      <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
        <div className="sm:col-span-12 lg:col-span-3">
          ...
          <div className="text-sm text-gray-600">
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-black uppercase">Fades Prasetya<br/> Nugroho</span>
          </div>
        </div>
